...
const std::string Roles::Cols::_meta = "meta";
const std::string Roles::Cols::_is_deleted = "is_deleted";
const std::string Roles::Cols::_created_at = "created_at";
const std::string Roles::Cols::_updated_at = "updated_at";
const std::string Roles::Cols::_deleted_at = "deleted_at";
...
const std::string &Roles::getValueOfMeta() const noexcept
{
    const static std::string defaultValue = std::string();
    if(meta_)
        return *meta_;
...
const std::shared_ptr<std::string> &Roles::getMeta() const noexcept
{
    return meta_;
}
void Roles::setMeta(const std::string &pMeta) noexcept
{
    meta_ = std::make_shared<std::string>(pMeta);
    dirtyFlag_[3] = true;
}
void Roles::setMeta(std::string &&pMeta) noexcept
{
    meta_ = std::make_shared<std::string>(std::move(pMeta));
    dirtyFlag_[3] = true;
}
void Roles::setMetaToNull() noexcept
{
    meta_.reset();
    dirtyFlag_[3] = true;
}

const bool &Roles::getValueOfIsDeleted() const noexcept
{
...
const std::shared_ptr<bool> &Roles::getIsDeleted() const noexcept
{
    return isDeleted_;
}
void Roles::setIsDeleted(const bool &pIsDeleted) noexcept
{
    isDeleted_ = std::make_shared<bool>(pIsDeleted);
    dirtyFlag_[4] = true;
}
void Roles::setIsDeletedToNull() noexcept
{
    isDeleted_.reset();
    dirtyFlag_[4] = true;
}
...
const ::trantor::Date &Roles::getValueOfDeletedAt() const noexcept
{
    const static ::trantor::Date defaultValue = ::trantor::Date();
    if(deletedAt_)
        return *deletedAt_;
...
const std::shared_ptr<::trantor::Date> &Roles::getDeletedAt() const noexcept
{
    return deletedAt_;
}
void Roles::setDeletedAt(const ::trantor::Date &pDeletedAt) noexcept
{
    deletedAt_ = std::make_shared<::trantor::Date>(pDeletedAt);
    dirtyFlag_[7] = true;
}
void Roles::setDeletedAtToNull() noexcept
{
    deletedAt_.reset();
    dirtyFlag_[7] = true;
}
